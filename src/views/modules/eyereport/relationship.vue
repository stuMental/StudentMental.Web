<template>
  <div class="mod-relationship-echarts">
    <el-row>
      <el-form :inline="true">
        <el-row>
          <el-form-item>
        ...
        <el-row
          v-for="(datastu,index) in dataForm.DataStus"
          :key="index"
        >
          <el-form-item
            label="部门"
          ...
          >
            ...
            >
              <el-tree
                ...
                node-key="deptId"
                ref="deptListTree"
                @current-change="((item)=>{deptListTreeCurrentChangeHandle(item, index)})"
          ...
          >
            ...
            <el-button
              type="danger"
              @click.prevent="removeDomain(datastu)"
            >删除</el-button>
          </el-form-item>
        </el-row>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    initChartLine() {
      ...
      this.chartLine = echarts.init(document.getElementById("relationship"));
